# NKP [ 2.17.0 ] Ubuntu Air-gapped Install

Change Log:
- 26-May-2026: 
  - Added 2.17.0 Updates.
...
Download CLI:
```
curl -L -o nkp_v2.17.0_linux_amd64.tar.gz 'https://nkp-cli-download-link'
```

Unzip CLI:
```
tar -xvf nkp_v2.17.0_linux_amd64.tar.gz
```

Download NKP Bundle
```
curl -L -o nkp-bundle_v2.17.0_linux_amd64.tar.gz 'https://nkp-bundle-download-link'
```

Unzip bundle:
```
tar -xvf nkp-bundle_v2.17.0_linux_amd64.tar.gz
```

Download NKP Air-Gapped Bundle:
```
curl -L -o nkp-air-gapped-bundle_v2.17.0_linux_amd64.tar.gz 'https://nkp-air-gapped-bundle-download-link'
```

Unzip Air-gapped Bundle:
```
tar -xvf nkp-air-gapped-bundle_v2.17.0_linux_amd64.tar.gz
```
...
Navigate to folder:
```
cd /data/inet/nkp-2.17.0/
```

Load bootstrap image:
```
docker load -i /data/inet/nkp-2.17.0/konvoy-bootstrap-image-v2.17.0.tar
```
...
export NUTANIX_VERSION='target-nkp-version'                                                    # Ex: 'v2.17.0'
```
