...
Download CLI:
```
curl -LO  --output-dir /data/inet nkp_v2.17.1_linux_amd64.tar.gz 'https://nkp-cli-download-link'
```
...
Install NKP-CLI:
```
install -o root -g root -m 0755 /data/inet/nkp-v2.17.1/cli/nkp /usr/local/bin/nkp
```
